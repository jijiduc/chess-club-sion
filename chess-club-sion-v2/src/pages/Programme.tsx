...
const Programme: React.FC = () => {
  ...
  return (
    <>
      ...
      <Meta name="description" content="Retrouvez le calendrier complet des événements du Club d'Échecs de Sion. Dates des soirées, des cours de formation et des prochains tournois." />
                ...
                .map(([key, label]) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-6 py-2 rounded-full font-medium transition-all flex items-center gap-2 ${selectedCategory === key
                        ? 'bg-gradient-to-r from-primary-600 to-primary-800 text-white shadow-lg'
                        : 'bg-white text-neutral-700 hover:bg-neutral-50 border border-neutral-300'
                        }`}
                    >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="relative bg-white rounded-xl shadow-lg p-6 border border-primary-100 hover:shadow-xl transition-all overflow-hidden">
                              ...
                              <div className={`absolute top-6 right-6 w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden ${event.image ? '' : (
