// tournoi-unified.js
// Fichier unifié pour la gestion du tournoi interne
...
function genererHtmlTournoi() {
    ...
    function genererRonde(ronde) {
        ...
        let html = `
        <div class="season-container round-container">
            <h3>Ronde ${ronde.numero}</h3>
            <div class="season-content round-content">`;
            
        if (estEnCours) {
            html += `
            <div class="round-alert">
                <p>Ronde en cours</p>
            </div>`;
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (container) {
        ...
        // Ajouter des animations d'entrée pour les conteneurs de ronde
    ...
    // Ajouter les écouteurs d'événements pour les sections dépliables
